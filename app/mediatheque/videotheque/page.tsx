...
function VideoGrid({
  ...
  const fetchVideos = useCallback(async () => {
    ...
    try {
      ...
      if (!response.ok || apiResponse.success !== 1)
  ...
  const filteredVideos = useMemo(() => {
    let filtered = videos;
    // Suppression du filtrage par catégorie
    if (searchTerm) {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      {filteredVideos.map((video) => (
        ...
        >
          ...
          <div className="p-4">
            <h3 className="text-lg font-semibold text-gray-800 mb-2 line-clamp-2 group-hover:text-orange-600">
              {video.title}
            </h3>
...
export default function VideothequePage() {
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`bg-gradient-to-br from-orange-50 to-white transition-all duration-300 ${
                  ...
                  <span className="flex items-center">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M8 7V3a1 1 0 011-1h6a1 1 0 011 1v4h3a1 1 0 011 1v8a1 1 0 01-1 1H4a1 1 0 01-1-1V8a1 1 0 011-1h3z"
                      />
                    </svg>
