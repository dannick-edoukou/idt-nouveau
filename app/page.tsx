...
// Composant StatCard pour gérer l'animation des cartes de statistiques
const StatCard = ({ stat, index }: { stat: typeof statistics[number]; index: number }) => {
...
export default function Home() {
  ...
  // breadcrumbItems moved to where it's needed
