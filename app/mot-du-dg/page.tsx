        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div className="grid lg:grid-cols-2 gap-0">
              {/* Section Image du DG */}
              <div
                className="relative p-8 flex items-center justify-center min-h-[600px]"
                style={{ background: 'linear-gradient(135deg, #f97316 0%, #059669 100%)' }}
              >
                {/* Badge "Créé en 2017" */}
                <div
                  className="absolute top-6 right-6 rounded-full px-4 py-2 shadow-lg"
                ...
                <div className="text-center text-white">
                  ...
                  <div
                    className="w-64 h-64 mx-auto rounded-full flex items-center justify-center mb-8 border-4 shadow-2xl overflow-hidden"
                    style={{ backgroundColor: 'rgba(255, 255, 255, 0.25)', backdropFilter: 'blur(8px)', borderColor: 'rgba(255, 255, 255, 0.5)' }}
                  >
                  ...
                  <div
                    ...
                    style={{ backgroundColor: 'rgba(255, 255, 255, 0.15)', backdropFilter: 'blur(8px)', borderColor: 'rgba(255, 255, 255, 0.3)' }}
                  >
              ...
              <div className="p-8 lg:p-12">
                <div className="max-w-2xl">
                  <div className="flex items-center mb-6">
                    ...
                    <h2 className="text-3xl font-bold text-gray-800 border-b-4 border-orange-500 pb-2">
                  ...
                  <div className="space-y-6 text-gray-700 leading-relaxed">
                    ...
                    <div className="space-y-4 ml-4">
                      ...
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p>La fourniture des services de multiplexage, de transport et de diffusion des chaînes, bouquets TV, et radios publiques et privées.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
