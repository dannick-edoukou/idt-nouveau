export default function LocationPylone() {
  return (
    <main className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Location de Pylône</h1>
      <div className="prose max-w-none">
        <div className="grid gap-8">
          {/* Section Présentation du Service */}
          <section className="bg-white rounded-lg shadow-lg p-6">
            <h2 className="text-2xl font-semibold mb-4">Notre Service de Location</h2>
            <div className="space-y-4">
              <p className="text-lg">
                Description du service de location de pylône...
              </p>
